...
const weightLoss = [
  ...
  "BellyFlush|https://cb.getbellyflush.com/",
  "ElectroSlim|https://cb.getelectroslim.com/",
...
const mentalHealth = ["Neurozoom|https://getneurozoom.com/"];

const sleepAndDreams = [
...
const womensHealth = [
  ...
  "Lean Loophole|https://leanloophole.com/",
...
const mensHealth = [
  ...
  "Clubhouse Fire|https://1.clubhousesupplements.com/",
  "ErecPrime|https://erecprime24.com/",
  ...
  "Alpha Surge|https://heroichustle.com/",
...
const dietarySupplements = [
  ...
  "Pineal Guardian|https://thepinealguardian.com/",
  ...
  "Arctic Blast|https://cb.getarcticblast.com/",
  "Nerve Fresh|https://sJointViveecure.nervefresh.com/",
  ...
  "GlucoBerry|https://bloodsugarberry.com/",
  "Flush Factor Plus|https://flushfactorplus.com/",
  "Balmorex Pro|https://balmorex.pro/",
  "Synogut|https://synogut101.com/",
  "NanoDefense Pro|https://nanodefensepro.com/",
  "NeuroQuiet|https://neuroquiethq.com/",
  "Claritox Pro|https://claritox.com/",
  "Venoplus 8|https://cb.venoplus8.com/",
  "Joint N-11|https://freedomfromjointpain.net/",
  "ZenCortex|https://zencortex24.com/",
  "Zeneara|https://zeneara.com/",
  "Metanail|https://metanailcomplex.com/",
  "SugarMute|https://sugarnix.com/",
  "Renew Dental Support|#",
  "Moringa Magic|https://www.moringa-magic.com/",
  "Resurge|https://resurge.com/",
  "CELLUCARE|https://getcellucare.com/",
  "Peak BioBoost|https://www.mypeakbiome.com/",
  "CogniCare Pro|https://getcognipro.com/",
  "Cardio Shield|https://getcardioshield.com/",
  "Gut Vita|https://www.gutvita.com/",
  "Longevity Activator|https://mylongevityactivator.com/",
  "Vision 20|https://bestvisionsupport.com/",
  "Nervovive|https://nervovive.com/",
  "MemoryFuel|https://thememoryfuel.com/",
  "TheyaVue|https://gettheyavue.com/",
  "VertiAid|https://vertiaid.com/",
  "Xitox Foot Pads|https://cb.getxitox.com/",
  "NuNerve|https://trynunerve.com/",
  "GlucoTonic|https://getglucotonic.com/",
  "MenoRescue|https://menorescue.com/",
  "Prosta Defend|https://prostaflush.com/",
  "DigestiStart|#",
  "GlycoMute|https://sweetfend.com/",
  ...
  "NeuroVera|https://theneurovera.com/",
  "GutOptim|https://gutoptim.com/",
  ...
  "BIOptimizers|https://magbreakthrough.com/",
  ...
  "Gut Go|https://getgutgo.com/",
  "Keravita|https://getkeravitapro101.com/",
  "Blood Sugar Blaster|https://secure.bloodsugarblaster.com/",
  "Trimology|#",
  "Joint Glide|https://getjointglide.com/",
  "Advanced Mitochondrial Formula|https://www.advancedbionutritionals.com/",
  ...
  "Flexafen|https://cb.flexafen.com/",
  "Prostastream|https://prostastream.com/",
  "CerebroZen|https://cerebrozen24.com/",
  "SlimLeaf|https://getslimleaf.com/",
  "RegenVive|https://regainrejuvenate.com/",
  ...
  "BloodArmor|https://bloodarmor.net/",
...
const generateBlogContent = (name, category, issue, link) => {
  return `
    <h2>Introduction</h2>
    ...
    <h2>Benefits</h2>
    <ul>
      <li>Supports long-term goals relating to ${category.toLowerCase()}.</li>
    ...
    <h2>Final Verdict</h2>
    <p>${name} stands out as a promising, science-backed approach to managing ${category}. Its commitment to natural ingredients and transparent manufacturing provides significant peace of mind. While not a magic pill, it is a highly viable tool for your daily protocol.</p>
...
categoryMapping.forEach(cat => {
  cat.list.forEach(itemStr => {
    const [name, link] = itemStr.split('|');
    const slug = slugify(name);
    
    const contentHtml = generateBlogContent(name, cat.name, cat.issue, link);
    
    allProducts.push({
      id: globalId++,
      name: name,
      title: \`\${name} Review 2026: Is It Worth It or Scam?\`,
      category: cat.name,
      categorySlug: cat.id,
      slug: slug,
      image: \`https://source.unsplash.com/800x600/?\${cat.id},health,supplement,bottle&\${globalId}\`,
      rating: (4.2 + Math.random() * 0.7).toFixed(1),
      metaTitle: \`\${name} Review 2026 – Does It Really Work?\`,
      metaDescription: \`Honest \${name} review covering ingredients, benefits, pros & cons, and real results for individuals dealing with \${cat.issue}.\`,
      keywords: [\`\${name} review\`, \`\${cat.name.toLowerCase()} supplement\`, \`\${name} results\`, "buy online"],
      shortDescription: \`\${name} is a targeted formulation designed to support \${cat.name.toLowerCase()} naturally and effectively.\`,
      excerpt: \`Dealing with \${cat.issue}? Explore our comprehensive review of \${name} to see if its natural ingredients live up to the clinical hype.\`,
      content: contentHtml,
...
const outputData = \`export const generatedReviews = \${JSON.stringify(allProducts, null, 2)};\`;
fs.writeFileSync(path.join(__dirname, '../src/data/generatedReviews.js'), outputData, 'utf-8');
console.log(\`Successfully generated \${allProducts.length} reviews!\`);
